...
public class ThemeCommonGreen implements ThemeRow {
    private Map<String, String> colorRow;
    private Map<String, Integer> integerMap;

    public ThemeCommonGreen() {
        ...
        colorRow.put(ThemeConstants.AC_1, "#0bda51");
        colorRow.put(ThemeConstants.AC_2, "#12be4c");
