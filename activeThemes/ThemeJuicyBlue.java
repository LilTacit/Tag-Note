...
public class ThemeJuicyBlue implements ThemeRow {
    private Map<String, String> colorRow;
    private Map<String, Integer> integerMap;

    public ThemeJuicyBlue() {
        colorRow = new HashMap<>();

        colorRow.put(ThemeConstants.BACK_1, "#ffffff");
        colorRow.put(ThemeConstants.BACK_2, "#00ddff");
        colorRow.put(ThemeConstants.BACK_3, "#00ddff");
        colorRow.put(ThemeConstants.BACK_4, "#f9f9f9");
        colorRow.put(ThemeConstants.AC_1, "#0090ff");
        colorRow.put(ThemeConstants.AC_2, "#007fff");
        colorRow.put(ThemeConstants.BACK_DARK, "#212c34");
        colorRow.put(ThemeConstants.BACK_DARK_2, "#1e282f");
        colorRow.put(ThemeConstants.BACK_DARK_LIGHT, "#e7f3f7");
        colorRow.put(ThemeConstants.DEEP_DARK, "#1c252c");
        colorRow.put(ThemeConstants.BACK_IC_COLOR, "#134148");
        colorRow.put(ThemeConstants.ERROR_COLOR, "#FF0000");
        colorRow.put(ThemeConstants.HINT, "#89c2d8");
