...
public class ThemeCommonOrange implements ThemeRow {
    private Map<String, String> colorRow;
    private Map<String, Integer> integerMap;

    public ThemeCommonOrange() {
        ...
        colorRow.put(ThemeConstants.AC_1, "#ffa800");
        colorRow.put(ThemeConstants.AC_2, "#ee9200");
